...
tk.Label(root, text='Game', font = ('ariel',45,), fg = 'red').pack()
...
playAgain = tk.Button(root, text = 'Play Again', font = ('ariel',15), fg='red', command = playAgain)

currentchar = "X"

play_area = tk.Frame(root, width=500, height=300, bg='black')
xoPointCountr = []
xPointCountr = []
oPointCountr = []
...
class XOPoint:
    ...
    def set(self):
        global currentchar
        if not self.value:
            self.button.configure(text=currentchar, bg='black', fg='white')
